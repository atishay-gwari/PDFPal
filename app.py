...
def handle_userinput(user_question):
    if st.session_state.conversation is not None:
        ...
        # Handle the case where the conversation is not initialized
        st.write("Chat initialization error. Please process your documents first or you dint press the Process button.`")
